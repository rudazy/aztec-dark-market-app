...
} & Pick<ContractInstance, 'publicKeys'>)): Promise<AztecAddress>;
/**
 ...
 */
export declare function computePartialAddress(instance: Pick<ContractInstance, 'originalContractClassId' | 'initializationHash' | 'salt' | 'deployer'> | {
    originalContractClassId: Fr;
    saltedInitializationHash: Fr;
}): Promise<Fr>;
/**
