import { ARCHIVE_HEIGHT, INITIAL_L2_BLOCK_NUM, L1_TO_L2_MSG_TREE_HEIGHT, NOTE_HASH_TREE_HEIGHT, NULLIFIER_TREE_HEIGHT, PUBLIC_DATA_TREE_HEIGHT } from '@aztec/constants';
...
export const AztecNodeApiSchema = {
    ...
    findLeavesIndexes: z.function().args(L2BlockNumberSchema, z.nativeEnum(MerkleTreeId), z.array(schemas.Fr).max(MAX_RPC_LEN)).returns(z.array(optional(inBlockSchemaFor(schemas.BigInt)))),
    ...
    getArchiveMembershipWitness: z.function().args(L2BlockNumberSchema, schemas.Fr).returns(MembershipWitness.schemaFor(ARCHIVE_HEIGHT).optional()),
    getNoteHashMembershipWitness: z.function().args(L2BlockNumberSchema, schemas.Fr).returns(MembershipWitness.schemaFor(NOTE_HASH_TREE_HEIGHT).optional()),
    ...
    getL2ToL1Messages: z.function().args(L2BlockNumberSchema).returns(z.array(z.array(schemas.Fr)).optional()),
    ...
    getBlocks: z.function().args(z.number().gte(INITIAL_L2_BLOCK_NUM), z.number().gt(0).lte(MAX_RPC_BLOCKS_LEN)).returns(z.array(L2Block.schema)),
    getPublishedBlocks: z.function().args(z.number().gte(INITIAL_L2_BLOCK_NUM), z.number().gt(0).lte(MAX_RPC_BLOCKS_LEN)).returns(z.array(PublishedL2Block.schema)),
    ...
    getPrivateLogs: z.function().args(z.number().gte(INITIAL_L2_BLOCK_NUM), z.number().lte(MAX_RPC_LEN)).returns(z.array(PrivateLog.schema)),
    getPublicLogs: z.function().args(LogFilterSchema).returns(GetPublicLogsResponseSchema),
    getContractClassLogs: z.function().args(LogFilterSchema).returns(GetContractClassLogsResponseSchema),
    getLogsByTags: z.function().args(z.array(schemas.Fr).max(MAX_RPC_LEN), optional(z.number().gte(1).lte(MAX_LOGS_PER_TAG).default(MAX_LOGS_PER_TAG))).returns(z.array(z.array(TxScopedL2Log.schema))),
    ...
    getValidatorStats: z.function().args(schemas.EthAddress, optional(schemas.BigInt), optional(schemas.BigInt)).returns(SingleValidatorStatsSchema.optional()),
