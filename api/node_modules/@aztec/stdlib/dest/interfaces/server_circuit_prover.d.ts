...
export interface ServerCircuitProver {
     ...
     * @param input - Input to the circuit.
     */
    getRootRollupProof(input: RootRollupPrivateInputs, signal?: AbortSignal, epochNumber?: number): Promise<PublicInputsAndRecursiveProof<RootRollupPublicInputs, typeof NESTED_RECURSIVE_PROOF_LENGTH>>;
    /**
     * Create a proof for the AVM circuit.
     * @param inputs - Inputs to the AVM circuit.
     */
    getAvmProof(inputs: AvmCircuitInputs, skipPublicInputsValidation?: boolean, // TODO(#14234)[Unconditional PIs validation]: Remove.
...
//# sourceMappingURL=server_circuit_prover.d.ts.map