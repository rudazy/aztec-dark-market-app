...
export interface PrivateKernelProver {
     ...
     */
    generateInitOutput(privateKernelInputsInit: PrivateKernelInitCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     */
    simulateInit(privateKernelInputsInit: PrivateKernelInitCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    generateInnerOutput(privateKernelInputsInner: PrivateKernelInnerCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and an empty kernel proof.
     */
    simulateInner(privateKernelInputsInner: PrivateKernelInnerCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    generateResetOutput(privateKernelInputsReset: PrivateKernelResetCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     */
    simulateReset(privateKernelInputsReset: PrivateKernelResetCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs and the kernel proof.
     */
    generateTailOutput(privateKernelInputsTail: PrivateKernelTailCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelTailCircuitPublicInputs>>;
    /**
     ...
     * @returns A Promise resolving to a ProofOutput object containing public inputs an empty kernel proof.
     */
    simulateTail(privateKernelInputsTail: PrivateKernelTailCircuitPrivateInputs): Promise<PrivateKernelSimulateOutput<PrivateKernelTailCircuitPublicInputs>>;
...
//# sourceMappingURL=private_kernel_prover.d.ts.map