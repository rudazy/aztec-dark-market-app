...
export declare class UpdatedClassIdHints {
    ...
    constructor(updatedClassIdWitness: MembershipWitness<typeof PUBLIC_DATA_TREE_HEIGHT>, updatedClassIdLeaf: PublicDataTreeLeafPreimage, updatedClassIdValues: DelayedPublicMutableValues);
    static getFields(fields: FieldsOf<UpdatedClassIdHints>): readonly [MembershipWitness<40>, PublicDataTreeLeafPreimage, DelayedPublicMutableValues];
