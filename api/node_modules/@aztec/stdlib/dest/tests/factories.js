...
export function makePublicKeys(seed = 0) {
    return new PublicKeys(new Point(new Fr(seed + 0), new Fr(seed + 1), false), new Point(new Fr(seed + 2), new Fr(seed + 3), false), new Point(new Fr(seed + 4), new Fr(seed + 5), false), new Point(new Fr(seed + 6), new Fr(seed + 7), false));
}
