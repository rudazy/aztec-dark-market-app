 ...
 */
export declare class TxRollupPublicInputs {
    /**
    ...
    static empty(): TxRollupPublicInputs;
    /**
     ...
     */
    static fromString(str: string): TxRollupPublicInputs;
    /** Returns a buffer representation for JSON serialization. */
    toJSON(): Buffer<ArrayBufferLike>;
    /** Creates an instance from a hex string. */
    static get schema(): import("zod").ZodType<TxRollupPublicInputs, any, string>;
}
//# sourceMappingURL=tx_rollup_public_inputs.d.ts.map